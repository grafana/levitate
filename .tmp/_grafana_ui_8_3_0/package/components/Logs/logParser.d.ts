 ...
 */
export declare const getAllFields: import("memoize-one").MemoizedFn<(row: LogRowModel, getFieldLinks?: ((field: Field, rowIndex: number) => Array<LinkModel<Field>>) | undefined) => FieldDef[]>;
export {};
