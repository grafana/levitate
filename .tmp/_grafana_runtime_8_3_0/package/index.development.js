...
var HistoryWrapper = /** @class */ (function () {
    ...
    HistoryWrapper.prototype.partial = function (query, replace) {
        ...
        try {
            for (var _b = __values$1(Object.keys(query)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
...
function toDataQueryResponse(res, queries) {
    ...
    if ((_f = res.data) === null || _f === void 0 ? void 0 : _f.results) {
        ...
        var data$1 = [];
        try {
            for (var refIDs_1 = __values$1(refIDs), refIDs_1_1 = refIDs_1.next(); !refIDs_1_1.done; refIDs_1_1 = refIDs_1.next()) {
        ...
        try {
            for (var data_1 = __values$1(data$1), data_1_1 = data_1.next(); !data_1_1.done; data_1_1 = data_1.next()) {
                ...
                if ((_g = dr.frames) === null || _g === void 0 ? void 0 : _g.length) {
                    try {
                        for (var _k = (e_3 = void 0, __values$1(dr.frames)), _l = _k.next(); !_l.done; _l = _k.next()) {
                            var js = _l.value;
                ...
                if ((_h = dr.series) === null || _h === void 0 ? void 0 : _h.length) {
                    try {
                        for (var _m = (e_4 = void 0, __values$1(dr.series)), _o = _m.next(); !_o.done; _o = _m.next()) {
                            var s = _o.value;
                            if (!s.refId) {
                                s.refId = dr.refId;
                            }
                ...
                if ((_j = dr.tables) === null || _j === void 0 ? void 0 : _j.length) {
                    try {
                        for (var _p = (e_5 = void 0, __values$1(dr.tables)), _q = _p.next(); !_q.done; _q = _p.next()) {
                            var s = _q.value;
                            if (!s.refId) {
                                s.refId = dr.refId;
                            }
...
exports.DataSourceWithBackend = /** @class */ (function (_super) {
    ...
    DataSourceWithBackend.prototype.query = function (request) {
        ...
        var queries = targets.map(function (q) {
            ...
            if (q.datasource) {
                var ds = getDataSourceSrv().getInstanceSettings(q.datasource, request.scopedVars);
                if (!ds) {
...
function toStreamingDataResponse(rsp, req, getter) {
    ...
    var streams = [];
    try {
        for (var _c = __values$1(rsp.data), _d = _c.next(); !_d.done; _d = _c.next()) {
            var f = _d.value;
