...
var fs = require("fs");
var githubClient_1 = (0, tslib_1.__importDefault)(require("./githubClient"));
...
var GitHubRelease = /** @class */ (function () {
    ...
    GitHubRelease.prototype.publishAssets = function (srcLocation, destUrl) {
        ...
        return files.map(function (file) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        pluginInfo = (0, pluginValidation_1.getPluginJson)(pluginJsonFile).info;
                        PUBLISH_DIR = path.resolve((0, env_1.getCiFolder)(), 'packages');
