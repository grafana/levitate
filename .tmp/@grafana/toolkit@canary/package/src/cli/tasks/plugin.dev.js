...
var bundlePlugin = function (options) {
    return (0, useSpinner_1.useSpinner)('Bundling plugin in dev mode', function () { return (0, bundle_1.bundlePlugin)(options); });
};
var yarnlink = function () {
    return (0, useSpinner_1.useSpinner)('Linking local toolkit', function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_e) {
            switch (_e.label) {
                ...
                case 4:
                    ...
                    try {
                        for (_a = (0, tslib_1.__values)(Object.entries(packages.dependencies)), _b = _a.next(); !_b.done; _b = _a.next()) {
                            _c = (0, tslib_1.__read)(_b.value, 2), key = _c[0], value = _c[1];
                            args.push(key + "@" + value);
                        }
                    }
    ...
    return (0, tslib_1.__generator)(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, bundle_1.bundlePlugin)(options)];
            case 1:
                _a.sent();
                return [3 /*break*/, 5];
            case 2: 
            // Always fix lint in dev mode
            return [4 /*yield*/, (0, plugin_build_1.lintPlugin)({ fix: true })];
            case 3:
                // Always fix lint in dev mode
                _a.sent();
