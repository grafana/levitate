...
var nodeVersionCheckerRunner = function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    return (0, tslib_1.__generator)(this, function (_c) {
        ...
        try {
            for (nodeVersionFiles_1 = (0, tslib_1.__values)(exports.nodeVersionFiles), nodeVersionFiles_1_1 = nodeVersionFiles_1.next(); !nodeVersionFiles_1_1.done; nodeVersionFiles_1_1 = nodeVersionFiles_1.next()) {
                file = nodeVersionFiles_1_1.value;
                fileContent = (0, fs_1.readFileSync)(process.cwd() + "/" + file);
                matches = fileContent.toString('utf8').match(pattern);
                if (!matches) {
                    continue;
                }
                try {
                    for (matches_1 = (e_2 = void 0, (0, tslib_1.__values)(matches)), matches_1_1 = matches_1.next(); !matches_1_1.done; matches_1_1 = matches_1.next()) {
                        match = matches_1_1.value;
                        actualVersion = (0, semver_1.coerce)(match);
                        if (!actualVersion) {
                            failures.push({
                                file: file,
                                line: match,
                        ...
                        satisfied = (0, semver_1.satisfies)(actualVersion, expectedVersion);
                        if (!satisfied) {
                            failures.push({
                                file: file,
                                line: match,
